...
# with command line options: step1 --filein root://cms-xrd-global.cern.ch///store/user/yohay/DIRNAME/HHMASS_aAMASS_2mu2tau_GEN-SIM_NEVENTSEvts_JOBNUM.root --fileout file:HHMASS_aAMASS_2mu2tau_DIGI-HLT_NEVENTSEvts_JOBNUM.root --pileup_input dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIISummer15GS-MCRUN2_71_V1-v2/GEN-SIM --mc --eventcontent RAWSIM --pileup 2016_25ns_SpringMC_PUScenarioV1_PoissonOOTPU --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_v3 --customise_commands process.simHcalDigis.markAndPass = cms.bool(True) --step DIGI,L1,DIGI2RAW,HLT:@frozen25ns --era Run2_25ns --python_filename 2mu2tau_DIGI-HLT.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n NEVENTS
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch///store/user/yohay/DIRNAME/HHMASS_aAMASS_2mu2tau_GEN-SIM_NEVENTSEvts_JOBNUM.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HHMASS_aAMASS_2mu2tau_DIGI-HLT_NEVENTSEvts_JOBNUM.root'),
